...
class Collector(threading.Thread):
    ...
    def run(self):
        ...
        with io.open(file_path, 'w', 1,encoding='utf-8') as out_csv_file, \
             io.open(log_path, 'w', 1, encoding='utf-8') as log_file:
            ...
            for current_date in tqdm(
                ...
                url = "https://spotifycharts.com/regional/%s/weekly/%s--%s/download" % (
                    self.region, current_date, current_date+SEVEN_DAYS)
                print(" " + url)
    ...
    def generate_final_file():
        ...
        with io.open(final_filename, 'w',encoding='utf-8') as outfile:
            ...
            for filename in tqdm(
                ...
                if filename.endswith(".csv"):
                    with io.open(os.path.join(DATA_DIR, filename),encoding='utf-8') as infile:
